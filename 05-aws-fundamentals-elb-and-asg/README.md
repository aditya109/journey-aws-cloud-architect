...
- **Application-based** cookies.
  ...
  - It could be:
    ...
    1. a *custom cookie*, which is,
       ...
       - Don't use <span style="color:yellow">AWSALB</span>, <span style="color:yellow">AWSALBAPP</span> or <span style="color:yellow">AWSALBTG</span> (reserved for use by the ELB)
    
    2. an *application cookie*, which is,
       
       - Generated by the load balancer,
       
       - Cookie name is <span style="color:yellow">AWSALBAPP</span>.

- **Duration-based** cookies. (or load balancer generated cookie)
  
  - Cookie generated by the load balancer
  
  - Cookie name is <span style="color:yellow">AWSALB</span> for ALB, <span style="color:yellow">AWSELB</span> for CLB.
